                                    ...
                                    <form >
                                        <div className="row">
                                            <div className="col-sm-12 form-group">
                                                <label className="form-label fs-5 mb-1 contact-text" htmlFor="message"> Message:</label>
                                                <textarea className="form-control mb-2" type="textarea" name="message" id="message" maxLength={"6000"} rows="7"></textarea>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="col-sm-6 form-group">
                                                <label className="form-label fs-5 mb-1 contact-text" htmlFor="name"> Your Name:
                                                    <input type="text" className="form-control" id="name" name="name" required />
                                                </label>
                                            </div>
                                            <div className="col-sm-6 form-group">
                                                <label className="form-label fs-5 mb-1 contact-text" htmlFor="email"> Email:
                                        ...
                                        <div className="row">
                                            <div className="col-sm-12 form-group">
                                                <button type="submit" id="contact-form-button" className="mt-2 btn btn-lg contact-text" >Send </button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
