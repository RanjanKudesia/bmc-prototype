                ...
                existingUser ?
                    <>
                        ...
                        <div className='container'>
                            ...
                            <button className="btn btn-outline-success " id='show-graph-button' type="button" data-bs-toggle="collapse" data-bs-target="#graph" aria-expanded="false" aria-controls="collapseWidthExample">
                                Show Graph
                            </button>
                            <p>
